 ...
 */
public class Rx10Activity extends AppCompatActivity {
    private final String TAG = Rx10Activity.class.getSimpleName();
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rx10);
    }
